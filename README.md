...
This is a _multipurpose_ Telegram Bot writen in Python for mirroring files on the Internet to our beloved Google Drive.
[
# Features supported:
## Additional Features
...
- Clone this repo:
```
git clone https://github.com/tandob/deepak-clouds-mirror/
cd mirrorbot
```
